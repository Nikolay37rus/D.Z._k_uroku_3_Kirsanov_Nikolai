...
namespace Д.З_к_уроку_3_Кирсанов_Николай_задание_3 //*Описать класс дробей - рациональных чисел, являющихся отношением двух целых чисел. Предусмотреть методы сложения, вычитания, умножения и деления дробей. Написать программу, демонстрирующую все разработанные элементы класса.
{
    class Fraction
{
        ...
        private Fraction Minus(Fraction fraction2)
        {
            throw new NotImplementedException();
        }

        private Fraction Plus(Fraction fraction2)
        {
            throw new NotImplementedException();
        }

        private Fraction Multi(Fraction fraction2)
        {
            throw new NotImplementedException();
        }

        private Fraction Division(Fraction fraction2)
        {
            throw new NotImplementedException();
        }
